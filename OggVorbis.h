...
#define VORBIS_CM_MONO 1                               /* Code for mono mode */
#define VORBIS_CM_STEREO 2                           /* Code for stereo mode */
#define VORBIS_CM_MULTICHANNEL 6               /* Code for Multichannel Mode */
#define XOR ^
...
static const unsigned int CRC_TABLE[] = {
	...
	public:
		...
		int GetBitRateNominal()         { return FBitRateNominal; };      /* Nominal bit rate */
