...
Begin VB.Form frmAPIC 
   ...
   Caption         =   "Informationen zu dem Bild"
   ClientHeight    =   3420
   ClientLeft      =   6555
   ClientTop       =   3195
   ClientWidth     =   6750
   ...
   Begin VB.CheckBox linkCheck 
      Caption         =   "Nur Dateiverweis statt Bilddaten"
      Height          =   255
      Left            =   3360
      TabIndex        =   6
      Top             =   2280
   ...
   Begin VB.Label Label1 
      Caption         =   "Beschreibung des Bildes Nummer:"
      Height          =   195
      Left            =   3360
      TabIndex        =   2
      Top             =   240
...
Private Sub cmdOk_Click()
  ...
  Call genie.ID3V2AddPictureFile(dateiInfo.Caption, picDescription.text, picType, linkCheck.value)
