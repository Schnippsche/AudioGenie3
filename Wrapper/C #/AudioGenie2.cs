...
// *                                                     *
// * using AudioGenie;                                   *
// * AudioGenie2.DisablePopupKey(keyValue);              *
// * AudioGenie2.AUDIOAnalyzeFile("test.mp3");           *
// * AudioGenie2.AUDIOTitle = "TEST";                    *
...
namespace AudioGenie
{
    ...
    public enum MP4FRAMES : uint
    {
        ...
        MP4_CDSETNUMBER = 0x6469736B, // disk
    ...
    public static class AudioGenie2
    {
        ...
        private static extern string AACGetBitRateTypeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AACGetHeaderTypeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AACGetProfileW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short APEExistsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetAlbumW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetArtistW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetCommentW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetCopyrightW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetGenreW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetItemKeysW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int APEGetSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetTitleW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetTrackW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetUserItemW(string Key);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string APEGetYearW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short APERemoveTagFromFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short APERemoveTagW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short APESaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short APESaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetAlbumW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetArtistW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetCommentW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetCopyrightW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetGenreW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetTitleW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetTrackW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetUserItemW(string Key, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void APESetYearW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short AUDIOAnalyzeFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short AUDIOIsValidFormatW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetAlbumW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetArtistW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int AUDIOGetBitrateW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetChannelModeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int AUDIOGetChannelsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetCommentW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetComposerW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int AUDIOGetDurationMillisW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern float AUDIOGetDurationW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int AUDIOGetFileSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetGenreW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int AUDIOGetLastErrorNumberW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetLastErrorTextW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetLastFileW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetMD5ValueW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int AUDIOGetSampleRateW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetTitleW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetTrackW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string AUDIOGetYearW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short AUDIOSaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short AUDIOSaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetAlbumW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetArtistW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetCommentW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetComposerW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetGenreW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetTitleW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetTrackW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void AUDIOSetYearW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetBitsPerSampleW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern float FLACGetCompressionRatioW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string FLACGetItemKeysW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetMaxBlockSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetMaxFrameSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetMinBlockSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetMinFrameSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetSamplesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string FLACGetUserItemW(string ItemKey);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string FLACGetVendorW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACSaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACSaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void FLACSetUserItemW(string ItemKey, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void FLACSetVendorW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string GetAudioGenieVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int GetConfigValueW(int key);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string GetMD5ValueFromFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V1ExistsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V1GetAlbumW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V1GetArtistW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V1GetCommentW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        ...
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V1GetGenreW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V1GetGenresW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        ...
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V1GetVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V1GetYearW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V1RemoveTagFromFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V1RemoveTagW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V1SaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V1SaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void ID3V1SetAlbumW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void ID3V1SetArtistW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void ID3V1SetCommentW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        ...
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddAudioEncryptionW(byte[] arr, int maxLen, string URL, short PreviewStart, short PreviewLength);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddAudioSeekPointW(byte[] arr, int maxLen, int start, int length, short numbers, byte BitsPerPoint);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddChapterW(string ID, string Title, string Description, int startTime, int endTime);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddChildElementW(string ParentTocID, string ChildID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddCommentW(string Language, string Description, string Text);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddCommercialFrameW(byte[] arr, int maxLen, string Price, string validUntil, string contactUrl, short receivedAs, string seller, string description);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddEncryptionW(byte[] arr, int maxLen, string URL, short Symbol);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddEqualisationW(byte[] arr, int maxLen, byte Interpolationmethod, string Identification);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddEventTimingCodesW(byte[] arr, int maxLen, byte TimestampFormat);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddGeneralObjectW(byte[] arr, int maxLen, string Mime, string FileName, string Description);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddGroupIdentificationW(byte[] arr, int length, string Url, byte symbol);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddLinkedInformationW(int FrameIdentifier, string URL, string additionalData);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddLyricW(string Language, string Description, string Text);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddMpegLocationLookupTableW(byte[] arr, int length, int Frames, int Bytes, int Milliseconds, byte BytesDeviation, byte MillisecondsDeviation);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddMusicCdIdentifierW(byte[] arr, int length);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddOwnershipW(string Price, string dateString, string Seller);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddPictureArrayW(byte[] arr, int maxLen, string Description, short PictureType);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddPictureFileW(string FileName, string Description, short PictureType, short asLink);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddPopularimeterW(string Email, short Rating, int Counter);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddPositionSynchronisationW(byte TimestampFormat, int Position);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddPrivateFrameW(byte[] arr, int length, string URL);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddRecommendedBufferSizeW(int BufferSize, byte EmbeddedInfoFlag, int Offset);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddRelativeVolumeAdjustmentW(byte[] arr, int length, string Identifier);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddReverbW(short reverbLeft, short reverbRight, byte bouncesLeft, byte bouncesRight, byte feedbackLeftToLeft, byte feedbackLeftToRight, byte feedbackRightToRight, byte feedbackRightToLeft, byte premixLeftToRight, byte premixRightToLeft);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddSignatureFrameW(byte[] arr, int length, short GroupSymbol);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddSyncLyricW(string Language, string Description, string Text, short ContentType, short TimeStampFormat);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddSynchronizedTempoW(byte[] arr, int length, short Format);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddTableOfContentW(string ID, string Title, string Description, short isOrdered);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddUniqueFileIdentifierW(byte[] arr, int length, string Owner);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddUserFrameW(string Language, string Text);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddUserTextW(string Description, string Text);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddUserURLW(string Description, string URL);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2DeleteAddendumW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2DeleteAllFramesW(ID3V2FRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2DeleteChildElementW(string ParentTocID, string ChildID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2DeleteSelectedFrameW(ID3V2FRAMES FrameID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2DeleteSubFrameW(string ID, ID3V2FRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2ExistsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetAddendumDescriptionW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetAddendumTitleW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetAddendumTypeW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetAllFrameIDsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetAudioEncryptionDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetAudioEncryptionPreviewLengthW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetAudioEncryptionPreviewStartW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetAudioEncryptionURLW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetAudioSeekPointBitsPerIndexpointW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetAudioSeekPointDataW(byte[] arr, int maxLen);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetAudioSeekPointLengthW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetAudioSeekPointNumberW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetAudioSeekPointStartW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetChapterEndTimeW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetChapterStartTimeW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetChildElementIDW(string ID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetChildElementsW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommentDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommentLanguageW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommentW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommercialFrameContactURLW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommercialFrameDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommercialFramePictureMimeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetCommercialFramePictureW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommercialFramePriceW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetCommercialFrameReceivedAsW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommercialFrameSellerNameW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetCommercialFrameValidUntilW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetEncodingW(ID3V2FRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetEncryptionDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetEncryptionSymbolW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetEncryptionURLW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetEqualisationAdjustmentBitsW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetEqualisationDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetEqualisationIdentificationW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetEqualisationInterpolationW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetEventTimingCodesDataW(byte[] arr, int maxLen);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetEventTimingCodesTimestampFormatW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetFrameCountW(ID3V2FRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetGeneralObjectDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetGeneralObjectDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetGeneralObjectFilenameW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetGeneralObjectMimeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetGenreW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetGroupIdentificationDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetGroupIdentificationSymbolW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetGroupIdentificationURLW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetLinkedInformationAdditionalDataW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetLinkedInformationFrameIdentifierW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetLinkedInformationURLW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetLyricDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetLyricLanguageW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetLyricW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetMpegLocationLookupTableBytesDeviationW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetMpegLocationLookupTableBytesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetMpegLocationLookupTableDataW(byte[] arr, int maxLen);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetMpegLocationLookupTableFramesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetMpegLocationLookupTableMillisecondsDeviationW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetMpegLocationLookupTableMillisecondsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetMusicCdIdentifierDataW(byte[] arr, int maxLen);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetOwnershipDateW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetOwnershipPriceW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetOwnershipSellerW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetPictureArrayW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetPictureDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetPictureFileW(string FileName, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetPictureMimeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetPictureTypeTextW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetPictureTypeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetPlayCounterW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetPopularimeterCounterW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetPopularimeterEmailW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetPopularimeterRatingW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetPositionSynchronisationTimestampFormatW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetPositionSynchronisationValueW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetPossibleCHAPIDW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetPossibleTOCIDW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetPrivateFrameDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetPrivateFrameURLW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetRecommendedBufferSizeFlagW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetRecommendedBufferSizeOffsetW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetRecommendedBufferSizeValueW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetRelativeVolumeAdjustmentDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetRelativeVolumeAdjustmentIdentifierW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbBouncesLeftW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbBouncesRightW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbFeedbackLeftToLeftW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbFeedbackLeftToRightW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbFeedbackRightToLeftW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbFeedbackRightToRightW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbLeftW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbPremixLeftToRightW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbPremixRightToLeftW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetReverbRightW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetSeekOffsetW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetSignatureFrameDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetSignatureFrameGroupSymbolW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetSubFrameDescriptionW(string ID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetSubFrameIDW(string ID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetSubFrameImageTypeW(string ID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetSubFrameImageW(byte[] arr, int maxLen, string ID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetSubFrameTextW(string ID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetSubFrameTypeW(string ID, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetSubFramesW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetSyncLyricContentTypeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetSyncLyricDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetSyncLyricLanguageW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetSyncLyricTimeFormatW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetSyncLyricW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetSynchronizedTempoDataW(byte[] arr, int maxLen);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetSynchronizedTempoFormatW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2GetTOCIsOrderedW(string ID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetTOCRootIDW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetTextFrameW(ID3V2FRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetURLFrameW(ID3V2FRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetUniqueFileIdentifierDataW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetUniqueFileIdentifierOwnerW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetUserFrameLanguageW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetUserFrameW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetUserTextDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetUserTextW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetUserURLDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetUserURLW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string ID3V2GetVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2ImportCueFileW(String FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2RemoveTagFromFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2RemoveTagW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetAddendumDescriptionW(string ID, string newDescription);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetAddendumTitleW(string ID, string newTitle);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetChapterTimesW(string ID, int startTime, int endTime);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetFormatAndEncodingW(short format, short encoding);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void ID3V2SetGenreW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetImageSubFrameW(byte[] arr, int maxLen, string ID, string Description, PictureType pictureType);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void ID3V2SetPlayCounterW(int counter);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2AddSeekOffsetW(int offset);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetTOCIsOrderedW(string ID, short status);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void ID3V2SetTextFrameW(ID3V2FRAMES FrameID, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetTextSubFrameW(string ID, ID3V2FRAMES FrameID, string textString, string description);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void ID3V2SetURLFrameW(ID3V2FRAMES FrameID, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short ID3V2SetURLSubFrameW(string ID, ID3V2FRAMES FrameID, string urlString, string description);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short LYRICSExistsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetAlbumW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetArtistW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetAuthorW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetGenreW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetImageLinkW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetIndicationW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetInformationW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetLyricsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int LYRICSGetSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int LYRICSGetStartPositionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetTitleW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string LYRICSGetVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short LYRICSRemoveTagFromFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short LYRICSRemoveTagW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short LYRICSSaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short LYRICSSaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetAlbumW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetArtistW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetAuthorW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetGenreW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetImageLinkW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetIndicationW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetInformationW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetLyricsW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void LYRICSSetTitleW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MONKEYGetBitsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern float MONKEYGetCompressionRatioW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MONKEYGetCompressionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MONKEYGetFramesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern float MONKEYGetPeakW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MONKEYGetSamplesPerFrameW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MONKEYGetSamplesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void MP4DeleteEntriesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void MP4DeletePictureW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void MP4DeletePicturesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MP4GetTextFrameW(MP4FRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MP4GetAllFrameIDsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MP4GetGenreW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MP4GetiTuneFrameW(string FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MP4GetPictureArrayW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MP4GetPictureCountW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MP4GetPictureFileW(string FileName, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MP4GetPictureMimeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MP4GetTrackW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MP4GetVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MP4SaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MP4SaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void MP4SetGenreW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void MP4SetiTuneFrameW(string FrameID, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MP4AddPictureArrayW(byte[] arr, int maxLen);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MP4AddPictureFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void MP4SetTextFrameW(MP4FRAMES FrameID, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void MP4SetTrackW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MPEGGetEmphasisW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string MPEGGetEncoderW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MPEGGetFramePositionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MPEGGetFrameSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MPEGGetFramesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        ...
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGIsCopyrightedW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGIsOriginalW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGIsPaddingW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGIsPrivateW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGIsProtectedW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGIsVBRW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGSetCopyrightedW(string FileName, short newValue);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGSetOriginalW(string FileName, short newValue);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPEGSetPrivateW(string FileName, short newValue);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MPPGetFramesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short MPPGetStreamVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetAlbumW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetArtistW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int OGGGetBitRateNominalW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetCommentW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetCopyrightW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetDateW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetDescriptionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetGenreW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetISRCW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetItemKeysW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetLicenseW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetLocationW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetOrganizationW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetPerformerW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetTitleW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetTrackW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetUserItemW(string ItemKey);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetVendorW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetVersionW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short OGGRemoveTagFromFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short OGGRemoveTagW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short OGGSaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short OGGSaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetAlbumW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetArtistW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetCommentW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetCopyrightW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetDateW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetDescriptionW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetGenreW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetISRCW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetLicenseW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetLocationW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetOrganizationW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetPerformerW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetTitleW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetTrackW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetUserItemW(string ItemKey, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetVendorW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetVersionW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string OGGGetContactW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void OGGSetContactW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void SetConfigValueW(int key, int value);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void SetLogFileW(string fileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int WAVGetBitsPerSampleW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int WAVGetBlockAlignW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int WAVGetBytesPerSecondW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WAVGetCartChunkEntryW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int WAVGetChannelsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WAVGetFormatIDW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WAVGetFormatW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int WAVGetHeaderSizeW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WAVGetInfoChunkIDsW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WAVGetTextFrameW(WAVFRAMES FrameID);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WAVSaveChangesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WAVSaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void WAVSetCartChunkEntryW(short Index, string newValue);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void WAVSetTextFrameW(WAVFRAMES FrameID, string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMAAddPictureArrayW(byte[] arr, int maxLen, string Description, short PictureType, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMAAddPictureFileW(string FileName, string Description, short PictureType, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMADeletePictureW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void WMADeletePicturesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WMAGetItemKeysW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int WMAGetPictureArrayW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WMAGetPictureDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMAGetPictureFileW(string FileName, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WMAGetPictureMimeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMAGetPictureTypeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMAGetPictureCountW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACAddPictureArrayW(byte[] arr, int Length, string Description, short PictureType);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACAddPictureFileW(string FileName, string Description, short PictureType, short asLink);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACDeletePictureW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void FLACDeletePicturesW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetPictureArrayW(byte[] arr, int maxLen, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACGetPictureCountW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string FLACGetPictureDescriptionW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACGetPictureFileW(string FileName, short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string FLACGetPictureMimeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int FLACGetPictureSizeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string FLACGetPictureTypeTextW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short FLACGetPictureTypeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int ID3V2GetPictureSizeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int MP4GetPictureSizeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern int WMAGetPictureSizeW(short Index);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WAVGetDisplayTextW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void WAVSetDisplayTextW(string textString);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        [return: MarshalAs(UnmanagedType.BStr)]
        private static extern string WMAGetUserItemW(string ItemKey);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMAIsVBRW();
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMASaveChangesToFileW(string FileName);
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern short WMASaveChangesW();        
        [DllImport("AudioGenie3.dll", CharSet = CharSet.Unicode, SetLastError = true, ExactSpelling = true)]
        private static extern void WMASetUserItemW(string ItemKey, string textString);
        ...
        public static long ID3V2GetSeekOffset()
        {
        ...
        {
            return WAVGetCartChunkEntryW((short)Index);
        }
        ...
        // ---- Funktionen der aktuellen DLL, die bisher im Wrapper fehlten
        ...
        {
            int maxLen = FLACGetPictureSizeW(Index);
            if (maxLen <= 0)
                return new byte[0];
            byte[] dummy = new byte[maxLen];
        ...
        public static string WAVGetDisplayText()
        {
            return WAVGetDisplayTextW();
        }
        public static void WAVSetDisplayText(string textString)
        {
            WAVSetDisplayTextW(textString);
        }
