...
#Region "Native Methods"
        ...
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
         Private Function AACGetBitRateTypeW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AACGetHeaderTypeW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AACGetProfileW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEExistsW() As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetAlbumW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetArtistW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetCommentW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetCopyrightW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetGenreW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetItemKeysW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetSizeW() As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetTitleW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetTrackW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetUserItemW(ByVal Key As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function APEGetYearW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetAlbumW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetArtistW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetBitrateW() As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetChannelModeW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetChannelsW() As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetCommentW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetComposerW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetGenreW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetLastErrorNumberW() As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetLastErrorTextW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetLastFileW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetMD5ValueW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetSampleRateW() As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetTitleW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetTrackW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function AUDIOGetYearW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetItemKeysW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetUserItemW(ByVal ItemKey As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetVendorW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Sub
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function GetAudioGenieVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function GetConfigValueW(ByVal key As Integer) As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function GetMD5ValueFromFileW(ByVal FileName As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V1ExistsW() As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V1GetAlbumW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V1GetArtistW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V1GetCommentW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V1GetGenreW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V1GetVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V1GetYearW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetAddendumDescriptionW(ByVal ID As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetAddendumTitleW(ByVal ID As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetAddendumTypeW(ByVal ID As String) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetAllFrameIDsW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetAudioEncryptionURLW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetChildElementIDW(ByVal ID As String, ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetChildElementsW(ByVal ID As String) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommentDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommentLanguageW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommentW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommercialFrameContactURLW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommercialFrameDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommercialFramePictureMimeW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommercialFramePriceW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommercialFrameReceivedAsW(ByVal Index As Short) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommercialFrameSellerNameW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetCommercialFrameValidUntilW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetEncryptionURLW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetEqualisationIdentificationW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetGeneralObjectDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetGeneralObjectFilenameW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetGeneralObjectMimeW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetGenreW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetGroupIdentificationURLW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetLinkedInformationAdditionalDataW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetLinkedInformationFrameIdentifierW(ByVal Index As Short) As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetLinkedInformationURLW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetLyricDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetLyricLanguageW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetLyricW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetOwnershipDateW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetOwnershipPriceW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetOwnershipSellerW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPictureArrayW(ByVal arr As Byte(), ByVal maxLen As Integer, ByVal Index As Short) As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPictureDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPictureFileW(ByVal FileName As String, ByVal Index As Short) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPictureMimeW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPictureTypeTextW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPopularimeterEmailW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPossibleCHAPIDW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPossibleTOCIDW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPrivateFrameDataW(ByVal arr As Byte(), ByVal maxLen As Integer, ByVal Index As Short) As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetPrivateFrameURLW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetRelativeVolumeAdjustmentIdentifierW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetSubFrameDescriptionW(ByVal ID As String, ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetSubFrameTextW(ByVal ID As String, ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetSyncLyricDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetSyncLyricLanguageW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetSyncLyricTimeFormatW(ByVal Index As Short) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetSyncLyricW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetTOCRootIDW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetTextFrameW(ByVal FrameID As ID3V2FRAMES) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetURLFrameW(ByVal FrameID As ID3V2FRAMES) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetUniqueFileIdentifierOwnerW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetUserFrameLanguageW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetUserFrameW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetUserTextDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetUserTextW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetUserURLDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetUserURLW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function ID3V2GetVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetAlbumW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetArtistW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetAuthorW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetGenreW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetImageLinkW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetIndicationW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetInformationW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetLyricsW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetTitleW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function LYRICSGetVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MONKEYGetCompressionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Sub
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MP4GetTextFrameW(ByVal FrameID As MP4FRAMES) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MP4GetAllFrameIDsW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MP4GetGenreW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MP4GetiTuneFrameW(ByVal FrameID As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MP4GetPictureMimeW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MP4GetTrackW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MP4GetVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Sub
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MPEGGetEmphasisW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function MPEGGetEncoderW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetAlbumW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetArtistW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetBitRateNominalW() As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetCommentW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetCopyrightW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetDateW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetDescriptionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetGenreW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetISRCW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetItemKeysW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetLicenseW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetLocationW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetOrganizationW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetPerformerW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetTitleW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetTrackW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetUserItemW(ByVal ItemKey As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetVendorW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetVersionW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Sub
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function OGGGetContactW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVGetCartChunkEntryW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVGetFormatW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVGetHeaderSizeW() As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVGetInfoChunkIDsW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVGetTextFrameW(ByVal FrameID As WAVFRAMES) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVSaveChangesW() As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVSaveChangesToFileW(ByVal FileName As String) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Sub WAVSetCartChunkEntryW(ByVal Index As Short, ByVal newValue As String)
        End Sub
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Sub
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WMAGetItemKeysW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WMAGetPictureArrayW(ByVal arr As Byte(), ByVal maxLen As Integer, ByVal Index As Short) As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WMAGetPictureDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WMAGetPictureFileW(ByVal FileName As String, ByVal Index As Short) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WMAGetPictureMimeW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACAddPictureArrayW(ByVal arr As Byte(), ByVal Length As Integer, ByVal Description As String, ByVal PictureType As Short) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetPictureDescriptionW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetPictureFileW(ByVal FileName As String, ByVal Index As Short) As Short
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetPictureMimeW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetPictureSizeW(ByVal Index As Short) As Integer
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function FLACGetPictureTypeTextW(ByVal Index As Short) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        ...
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WAVGetDisplayTextW() As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Sub WAVSetDisplayTextW(ByVal textString As String)
        End Sub
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
        Private Function WMAGetUserItemW(ByVal ItemKey As String) As <MarshalAs(UnmanagedType.BStr)> String
        End Function
        <DllImport("AudioGenie3.dll", CharSet:=CharSet.Unicode, SetLastError:=True, ExactSpelling:=True)> _
...
#Region "ID3V2 Methods"
        ...
        End Function
        Public Function ID3V2GetSeekOffset() As Long
        ...
        Public Function ID3V2GetPictureArray(ByVal Index As Short) As Byte()
            Dim maxLen As Integer = 5000000
            ' 5MB 
            Dim dummy As Byte() = New Byte(maxLen - 1) {}
...
#Region "WMA Methods"
        ...
        Public Function FLACGetPictureArray(ByVal Index As Short) As Byte()
            Dim maxLen As Integer = FLACGetPictureSizeW(Index)
            If maxLen <= 0 Then
                Return New Byte() {}
            End If
            Dim dummy As Byte() = New Byte(maxLen - 1) {}
        ...
        End Function
        Public Function WAVGetDisplayText() As String
            Return WAVGetDisplayTextW()
        End Function
        Public Sub WAVSetDisplayText(ByVal textString As String)
